        ...
        <div class="col-8"> 
            <div class="card"> 
                <div class="card-body" style="width:90%"> 
                  <form method="POST" action="/update_room/{{ $data->id }}"> 
                    @csrf 
                    @method('put') 
                    <div class="mb-3"> 
                   ...
                   <div class="mb-3"> 
                        ...
                        <input type="text" name="payment" value="{{ $data->payment }}" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"> 
                        @error('payment') 
                        <div class=""> 
                            {{ $message }} 
                        </div> 
